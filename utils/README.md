...
To run the build tasks:
 ...
 1. `cd /path/to/keyboardteleopjs/utils/`
 2. `grunt build`

`grunt build` will concatenate and minimize the files under src and replace keyboardteleop.js and keyboardteleop.min.js in the build directory. It will also run the linter and test cases. This is what [Travis CI](https://travis-ci.org/WPI-RAIL/keyboardteleopjs) runs when a Pull Request is submitted.
